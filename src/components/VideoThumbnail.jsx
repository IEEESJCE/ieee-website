          ...
          <div className="video-gallery">
            <div className="gallery-item ">
              ...
              <div className="gallery-item-caption">
                <h2>IEEE EDS TALK</h2>
                <p>
                  The EDS chapter of IEEE-SJCE brings you a distinguished
                  lecture on, "Building an ecosystem for deep-tech
                  entrepreneurship in our academic institutions" by Dr. V
                  Ramgopal Rao, Professor and Immediate Past Director, IIT
                  Delhi.
                </p>
                <a
            ...
            <div className="gallery-item">
              ...
              <div className="gallery-item-caption">
                ...
                <p>
                  Alumni Podcast is a knowledge sharing interaction which
                  features alumni of SJCE and attempts to know more about their
                  college life, professional career, goals of the future and
                  their perspective on navigating their life as a human being
                </p>
                <a
                  className="vimeo-popup"
            ...
            <div className="gallery-item">
              <img
                src="/photos/gallery/video_img4.jpeg"
                alt="Mount St Helens"
              />
              <div className="gallery-item-caption">
