...
function Prayas() {
    ...
    return (
    <div>
      <h1 className="heading">Prayas</h1>
      <hr className="hr-1" />
      <p className="paragraph">
        PRAYAS is an outreach program by IEEE-SJCE WIE that provides inequitable
        education outcomes to underprivileged children. The volunteers visited
        an Orphanage every week to interact with the students and help them out
        in their academic activities
      </p>
      <div className="prayas">
        <div className="section_prayas">
          <h2 className="small_heading prayas_title" onClick={handleClick}>About Prayas</h2>
        ...
        <div className="section_prayas">
          <h2 className="small_heading prayas_title" onClick={handleClick}>What we do in Prayas</h2>
          <hr className="prayas_hr" />
        ...
        <div className="section_prayas">
          <h2 className="small_heading prayas_title" onClick={handleClick}>Why Prayas</h2>
          <hr className="prayas_hr" />
          <p className="prayas_para">
            ▪ Work satisfaction.<br/> ▪ Adds value to your profile. <br/>▪ Best platform
            to develop communication with society.<br/> ▪ A good start or continuity
            of your interest to serve the society
          </p>
        </div>
      </div>
    </div>
